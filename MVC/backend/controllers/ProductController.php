...
class ProductController extends Controller{
    ...
    public function upload_file(){
        if (isset($_POST['submit_file'])) {
            foreach ($_FILES['avatar_file'] AS $keys => $value) {
                if ($_FILES['avatar_file']['error'] == 0) {
                    ...
                    $file_size_mb = $_FILES['avatar_file']['size'] / 1024 / 1024;
                ...
                if (empty($this->error)) {
                    ...
                    if ($_FILES['avatar_file']['error'] == 0) {
                        ...
                        move_uploaded_file($_FILES['avatar_file']['tmp_name'], $dir_uploads . '/' . $filename);
                    }

                    $product_model = new Gallery();
                    $product_model->avatar_file = $filename;
    ...
    public function create()
    {
        ...
        if (isset($_POST['submit'])) {
            ...
            if (empty($this->error)) {
                ...
                $product_model->price_discount = $price_discount;
    ...
    public function update(){
        ...
        if (isset($_POST['submit'])) {
            ...
            if (empty($this->error)) {
                ...
                $is_insert = $product_model->update($id);
                if ($is_insert) {
