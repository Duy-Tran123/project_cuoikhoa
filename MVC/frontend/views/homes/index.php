...
<div class="ps-banner">
    <div class="rev_slider fullscreenbanner" id="home-banner">
        <ul>
            ...
            <li class="ps-banner ps-banner--white" data-index="rs-100" data-transition="random" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-rotate="0"><img class="rev-slidebg" src="assets/images/ban2.jpg" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="5" data-no-retina>
...
<div class="ps-section--offer">
    <div class="ps-column"><a class="ps-offer" href="danh-sach-san-pham"><img src="assets/images/home-banner-1.png" alt=""></a></div>
    <div class="ps-column"><a class="ps-offer" href="danh-sach-san-pham"><img src="assets/images/home-banner-2.png" alt=""></a></div>
</div>
                            ...
                            <div class="ps-shoe__content">
                                ...
                                <div class="ps-shoe__detail"><a class="ps-shoe__name" href="product-detai.html"><?php echo $product['title']; ?></a>
                                    ...
                                    <p>
                                        ...
                                        <strong>£ <?php echo $product['price_discount'] ?></strong>
                                    </p>
                                </div>
                            </div>
                        </div>
...
<div class="ps-home-testimonial bg--parallax pb-80" data-background="assets/images/parallax.jpg">
    <div class="container">
        <div class="owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000" data-owl-gap="0" data-owl-nav="false" data-owl-dots="true" data-owl-item="1" data-owl-item-xs="1" data-owl-item-sm="1" data-owl-item-md="1" data-owl-item-lg="1" data-owl-duration="1000" data-owl-mousedrag="on" data-owl-animate-in="fadeIn" data-owl-animate-out="fadeOut">
            <div class="ps-testimonial">
                <div class="ps-testimonial__thumbnail"><img src="assets/images/woman1.jpg" alt=""><i class="fa fa-quote-left"></i></div>
                <header>
            ...
            <div class="ps-testimonial">
                <div class="ps-testimonial__thumbnail"><img src="assets/images/woman2.jpg" alt=""><i class="fa fa-quote-left"></i></div>
                <header>
                    <select class="ps-rating">
                        <option value="1">1</option>
                        <option value="1">2</option>
            ...
            <div class="ps-testimonial">
                <div class="ps-testimonial__thumbnail"><img src="assets/images/woman3.jpg" alt=""><i class="fa fa-quote-left"></i></div>
                <header>
                    <select class="ps-rating">
                        <option value="1">1</option>
                        <option value="1">2</option>
...
<div class="ps-section ps-home-blog pt-80 pb-80">
    <div class="ps-container">
        <div class="ps-section__header mb-50">
            ...
            <div class="ps-section__action"><a class="ps-morelink text-uppercase" href="tin-tuc">View all post<i class="fa fa-long-arrow-right"></i></a></div>
        </div>
        <div class="ps-section__content">
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
                    <div class="ps-post">
                        <div class="ps-post__thumbnail"><a class="ps-post__overlay" href="blog-detail.html"></a><img src="assets/images/vlog1.jpg" alt=""></div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
                    <div class="ps-post">
                        <div class="ps-post__thumbnail"><a class="ps-post__overlay" href="blog-detail.html"></a><img src="assets/images/vlog2.jpg" alt=""></div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
                    <div class="ps-post">
                        <div class="ps-post__thumbnail"><a class="ps-post__overlay" href="blog-detail.html"></a><img src="assets/images/vlog3.jpg" alt=""></div>
