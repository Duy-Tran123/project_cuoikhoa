...
<!--                        <a href="#">(Read all 8 reviews)</a>-->
                    ...
                    <p class="ps-product__category"><a href="#"><?php echo $product['category_name'] ?></a></p>
                    <h3 class="ps-product__price">£ <?php echo $product['price_discount'] ?> <del>£ <?php echo $product['price'] ?></del></h3>
...
<!--                    </div>-->
                    ...
                    <div class="ps-product__shopping"><a class="ps-btn mb-10" href="them-vao-gio-hang/<?php echo $product['id']?>">Add to cart<i class="ps-icon-next"></i></a>
