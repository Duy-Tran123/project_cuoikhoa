    ...
    <nav class="navigation">
        <div class="container-fluid">
            <div class="navigation__column left">
                <div class="header__logo"><a class="ps-logo" href="index.php"><img src="assets/images/k1.png" alt=""></a></div>
            </div>
            <div class="navigation__column center">
                <ul class="main-menu menu">
                    ...
                    <li class="menu-item menu-item-has-children has-mega-menu"><a href="danh-sach-san-pham">PRODUCTS</a>
<!--                        <div class="mega-menu">-->
<!--                            <div class="mega-wrap">-->
...
<!--                    <li class="menu-item"><a href="#">Kids</a></li>-->
                    <li class="menu-item menu-item-has-children dropdown"><a href="tin-tuc">News</a>
                    </li>
                    <li class="menu-item menu-item-has-children dropdown"><a href="contact-us">Contact</a>

                    </li>
                    <li class="menu-item menu-item-has-children dropdown"><a href="about-our">About Our</a>
            ...
            <div class="navigation__column right">
                ...
                <div class="ps-cart"><a class="ps-cart__toggle" href="gio-hang-cua-ban"><span><i></i></span><i class="ps-icon-shopping-cart"></i></a>
